...
const HomePage = () => {
  ...
  return (
    <MainLayout>
      ...
      <div className="relative min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center px-2 sm:px-4 text-center">
        <div className="w-full max-w-4xl bg-white/80 backdrop-blur-md p-3 sm:p-6 md:p-8 rounded-2xl shadow-xl animate-fade-in"
          style={{ animationDelay: "0.1s" }}>
          {/* Title + Animation */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-3 md:mb-6 text-custom-darkBlue1 animate-fade-in" style={{ animationDelay: "0.21s" }}>
            <span className="text-custom-gold">Aptitude</span>
            <span className="ml-2">Ace</span>
          </h1>

          <p className="text-lg sm:text-xl mb-6 md:mb-8 text-custom-darkBlue2 max-w-2xl mx-auto animate-fade-in"
          ...
          {/* Main Feature Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-6 md:mb-12 max-w-2xl mx-auto">
            <HomeSectionCard
